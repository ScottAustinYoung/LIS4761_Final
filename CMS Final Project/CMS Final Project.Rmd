...
df_raw <- read_csv("Data/filtered_data.csv", show_col_types = FALSE) %>%
  mutate(
...
df_lm <- read_csv("Data/filtered_data.csv", show_col_types = FALSE) %>%
  select(
    Avg_Medicare_Payment,
    Total_Services,
    Avg_Submitted_Charge,
...
# Load Medicare data
medicare_cleaned <- read_csv("Data/filtered_data.csv", show_col_types = FALSE) %>%
  mutate(
