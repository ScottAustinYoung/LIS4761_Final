...
# Clean the FIPS_Code because it was giving error in k means column to remove non-numeric values
filtered_data$FIPS_Code <- as.numeric(gsub("[^0-9]", "", filtered_data$FIPS_Code))
